...
const StoreTable = ({ stores, setStores }) => {
  ...
  const handleAddStore = async () => {
    try {
      ...
      const res = await axios.post("http://localhost:3000/api/stores", storeToAdd);
  ...
  const handleUpdateStore = async () => {
    try {
      ...
      const res = await axios.put(`http://localhost:3000/api/stores/${selectedStore.StoreID}`, storeToUpdate);
      setStores((prevStores) =>
        prevStores.map((s) => (s.StoreID === selectedStore.StoreID ? res.data : s))
      );
                ...
                {selectedStore && (
                  <>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSelectedStore({ ...selectedStore, Latitude: e.target.value })
                      }
                    />
                    <input
                      className="form-control mb-2"
                      ...
                      onChange={(e) =>
                        setSelectedStore({ ...selectedStore, Longitude: e.target.value })
                      }
                    />
                    <input
                      className="form-control mb-2"
