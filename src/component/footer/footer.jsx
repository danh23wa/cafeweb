                ...
                <ul className="tch-footer__top__navbar-list mb-0 row">
                  <li className="col-12 col-md-6 col-lg-3">
                    <div className="tch-footer__navbar-item">
                      <div data-toggle="collapse" href="#tch-footer__navbar-1" aria-expanded="true" aria-controls="tch-footer__navbar-1" className="tch-footer__navbar-item-header">
                  ...
                  <li className="col-12 col-md-6 col-lg-3">
                    <div className="tch-footer__navbar-item">
                      <div data-toggle="collapse" href="#tch-footer__navbar-3" aria-expanded="true" aria-controls="tch-footer__navbar-3" className="tch-footer__navbar-item-header">
                  ...
                  <li className="col-12 col-md-6 col-lg-3">
                    <div className="tch-footer__navbar-item">
                      <div data-toggle="collapse" href="#tch-footer__navbar-34" aria-expanded="true" aria-controls="tch-footer__navbar-34" className="tch-footer__navbar-item-header">
                  ...
                  <li className="col-12 col-md-6 col-lg-3">
                    <div className="tch-footer__navbar-item">
                      <div data-toggle="collapse" href="#tch-footer__navbar-4" aria-expanded="true" aria-controls="tch-footer__navbar-4" className="tch-footer__navbar-item-header">
