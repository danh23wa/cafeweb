...
const ForgotPasswordPage = () => {
  ...
  const handleSendCode = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:3000/api/nguoidung/forgot-password', {
        method: 'POST',
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:3000/api/nguoidung/reset-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
